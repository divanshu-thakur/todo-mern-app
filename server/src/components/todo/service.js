...
let getTodoById = async (todoId, userId) => {
    ...
    if (!todo) throw new AppError(ERROR_CODES.TODO_NOT_FOUND, HTTP_STATUS.NOT_FOUND);
...
let updateTodo = async (todoId, userId, updateData) => {
    ...
    if (!updatedTodo) throw new AppError(ERROR_CODES.TODO_NOT_FOUND, HTTP_STATUS.NOT_FOUND);
...
let deleteTodo = async (todoId, userId) => {
    ...
    if (!deletedTodo) throw new AppError(ERROR_CODES.TODO_NOT_FOUND, HTTP_STATUS.NOT_FOUND);
